	...
	{
		{
			...
			GameObject* cameraObj = EventMgr::SpawnGameObject(eLayerType::Player, new GameObject);
		...
		{
			//Sprite 출력 테스트
			GameObject* spriteObj = EventMgr::SpawnGameObject(eLayerType::UI, new GameObject);
